...
// refers to the object in this case it's refer to the Student object.

// 2. What is "this" when joe.scopeArrow() is invoked?
// this is undefined, since the strict mode is enabled in this file.

// 3. Explain why "this" is different when an arrow function is used.
// because "this" is a keyword refers to different things depending on how it is used
// so in functions in general it's undefined when strict mode is enabled,
// and it refers to the object when it is being invoked with an object method.